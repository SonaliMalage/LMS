...
if(count($_POST)>0) {
	...
	$result = mysqli_query($conn,"SELECT * FROM student WHERE Username='" . $_POST["Username"] . "' and password = '". $_POST["password"]."'");
...
<div class="login-clean" style="background-image:url(&quot;assets/img/computer-lab-png-computer-lab-992.png&quot;);background-repeat:no-repeat;background-size:cover;">
  ...
  <h1 class="text-uppercase text-center justify-content-center" style="background-size:auto;font-weight:bold;font-family:Alegreya, serif;margin-top:-46px;background-color:#8c0100;color:rgb(255,255,255);">Login Form</h1>
