...
<h1 class="text-uppercase text-center justify-content-center" style="background-size:auto;font-weight:bold;font-family:Alegreya, serif;margin-top:-46px;background-color:#8c0100;color:rgb(255,255,255);"></h1>
  ...
  <br>
       ...
       <div class="form-group"><a role="button" class="btn btn-primary btn-block"  href="data12.php" style="background-color:rgb(170,5,40);font-size:20PX;">DATA ENTRY</a>
	   <a class="btn btn-primary btn-block" role="button" href="issue12.php" style="background-color:rgb(170,5,40);font-size:20PX;">ISSUE </a></button></div>
        </form><br><br>
    </div>
    <div></div>
