...
<div class="icon-bar">
  ...
  <div class="iconbar-right">
     ...
     <h1 class="text-uppercase text-center justify-content-center" style="background-size:auto;font-weight:bold;font-family:Alegreya, serif;margin-top:-46px;background-color:#8c0100;color:rgb(255,255,255);">reset password</h1>
        
          <form method="post" style="background-repeat:no-repeat;margin-top:87px;">
