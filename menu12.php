...
<h1 class="text-uppercase text-center justify-content-center" style="background-size:auto;font-weight:bold;font-family:Alegreya, serif;margin-top:-46px;background-color:#8c0100;color:rgb(255,255,255);"></h1>
      <br><br>
<form method="post" style="margin-top:56px;">
   <h2 class="sr-only">Login Form</h2><img src="logo.png" style="width:250PX;">
   
         <div class="illustration"></div>
     
       <div class="form-group"><a role="button" class="btn btn-primary btn-block"  href="report.php" style="background-color:rgb(170,5,40);font-size:20PX;">DATA REPORT</a>
	   <a class="btn btn-primary btn-block" role="button" href="issue12.php" style="background-color:rgb(170,5,40);font-size:20PX;">ISSUE REPORT</a></button></div>
        </form>
    </div>
    <div></div>
